define("ember-cli-mirage/serializers/ember-data-serializer", ["exports", "miragejs", "lodash-es"], function (_exports, _miragejs, _lodashEs) {
  "use strict";
  ...
  let EmberDataSerializer = _miragejs.RestSerializer.extend({
    ...
    _hashForModel(model, removeForeignKeys) {
      let didSerialize = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  ...
  var _default = EmberDataSerializer;
