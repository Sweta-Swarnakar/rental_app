  ...
  _flushPendingFetchForType(pendingFetchItems, modelName) {
    ...
    if (shouldCoalesce) {
      ...
      for (var _i6 = 0; _i6 < totalItems; _i6++) {
        var _internalModel6 = internalModels[_i6];
        snapshots[_i6] = _internalModel6.createSnapshot(optionsMap.get(_internalModel6));
      }
...
var assertRelationshipData = void 0;
var assertDestroyingStore = void 0;
var assertDestroyedStoreOnly = void 0;
