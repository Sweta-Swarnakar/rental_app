define('ember-data/-private', ['exports', 'ember-inflector', '@ember/ordered-set', 'ember-data/-debug', 'ember-data/version'], function (exports, emberInflector, EmberOrderedSet, Debug, VERSION) { 'use strict';
  ...
  */
  ...
  class ManyRelationship extends Relationship {
    ...
    _fetchLink(options) {
      return this.store.findHasMany(this.internalModel, this.link, this.relationshipMeta, options).then(records => {
  ...
  class BelongsToRelationship extends Relationship {
    ...
    //   and a link is available
    _fetchLink(options) {
      return this.store.findBelongsTo(this.internalModel, this.link, this.relationshipMeta, options).then(internalModel => {
        if (internalModel) {
          this.addInternalModel(internalModel);
        }
